        ...
        return (
            <div className="nav-container" id="navigation">
                ...
                <div className="nav-links function-links">
                    <Link to="/cart" id="cart-logo-container" className="nav-link s-shift function-link"><i className="fas fa-shopping-cart"></i></Link>
                    <Link to="/profile" className="nav-link s-shift function-link"><i className="fas fa-user-circle"></i></Link>
                    <div className="burger-menu" onClick={this.openNav}><i className="fas fa-bars open-nav function-link"></i></div>
                </div>
